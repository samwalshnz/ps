...
var Exec = module.exports = exports = function( args, options, callback) {
    ...
    if( IS_WIN ){
        ...
        ChildProcess.exec( 'ps ' + args, options, function( err, stdout, stderr) {
...
exports.lookup = function(query, options, callback) {
    ...
    return Exec( exeArgs, options, function(err, output) {
        if (err) {
            return callback( err );
        }
        else {
